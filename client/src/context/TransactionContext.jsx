  ...
  const getAllTransfers = async () => {
    try {
      if (ethereum) {
        ...
        const availableTransactions = await transactionContract.getAllTransfers();
  ...
  const sendTransaction = async () => {
    try {
      if (ethereum) {
        ...
        const transactionHash = await transactionContract.addTransfer(addressTo, parsedAmount, message, keyword);
